...
const AddDoctor = () => {
  ...
  const { data: services, isLoading } = useQuery(['services'], () => fetch(`https://doctors-portal-server-zafaremon20.vercel.app/services`)
    .then(res => {
    ...
    fetch(url, {
      ...
      .then(result => {
        if (result.success) {
          ...
          // send to data base
          fetch('https://doctors-portal-server-zafaremon20.vercel.app/doctor', {
            method: 'POST',
            headers: {
